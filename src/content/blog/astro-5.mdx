...
Il suffit d'aller sur l'UI de Vercel, de se connecter à GitHub et de choisir le repository.

Si le site est uniquement statique, il n'y a rien à configurer.

S'il utilise du SSR (``output: "server"` or `output: "hybrid"``) alors un adapter est nécessaire.
...
J'ai ajouté une icone SVG en composant React.
